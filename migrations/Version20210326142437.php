 ...
 */
final class Version20210326142437 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, idcandidat_id INT NOT NULL, formations VARCHAR(255) DEFAULT NULL, langues VARCHAR(254) DEFAULT NULL, diplome VARCHAR(254) DEFAULT NULL, UNIQUE INDEX UNIQ_B66FFE92CE119B2D (idcandidat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
